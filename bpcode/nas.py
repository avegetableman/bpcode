...
def create_index(project,name,version,timestamp):
    ...
    if not os.path.exists(jsonpath):
        ...
        version = versionlist.get(project,None)
...
def main():
    ...
    while True:
        ...
        for project,projectdir in projects.items():
            ...
            if localdict.get("version") == version and localdict.get("timestamp") == timestamp:
                continue
            ...
            if localversion == version and name == localdict.get("name"):
                continue
